    ...
    ERC1155TokenReceiver
{
    ...
    function _stake(address _sender, uint256 _amount) internal {
        require(_amount > 0, "amount should bigger than 0");
    ...
    function stakeNft(
        ...
        require(isInWhitelist(nftAddress, id), "nft id not in whitelist");
    ...
    function batchStakeNfts(
        ...
        _batchStakeNfts(msg.sender, address(this), _nftAddress, ids, values, data);
    }
    ...
    */
    function claim() external whenNotPaused nonReentrant {
        ...
        require(totalFunding >= interest, "not enough to pay interest");
